// backend/src/__tests__/unit/controllers/supportDataController.test.js
...
describe('Support Data Controller', () => {
  ...
  // Helper function to get the handler for a specific route
  const getRouteHandler = (path, method = 'get') => {
    ...
    const handler = route.route.stack.find(layer => 
      layer.method === method
    );
  ...
  describe('GET /commodities', () => {
    test('should return commodities list', async () => {
      ...
      const handler = getRouteHandler('/commodities');
  ...
  describe('GET /commodity-exclusions', () => {
    test('should return commodity exclusions list', async () => {
      ...
      // Get the handler
      const handler = getRouteHandler('/commodity-exclusions');
  ...
  describe('GET /equipment-types', () => {
    test('should return equipment types list', async () => {
      ...
      // Get the handler
      const handler = getRouteHandler('/equipment-types');
  ...
  describe('GET /load-types', () => {
    test('should return load types list', async () => {
      ...
      // Get the handler
      const handler = getRouteHandler('/load-types');
  ...
  describe('GET /freight-classes', () => {
    test('should return freight classes list', async () => {
      ...
      // Get the handler
      const handler = getRouteHandler('/freight-classes');
  ...
  describe('GET /terms-of-sales', () => {
    test('should return terms of sales list', async () => {
      ...
      // Get the handler
      const handler = getRouteHandler('/terms-of-sales');
  ...
  describe('POST /schedule', () => {
    test('should update refresh schedule', async () => {
      ...
      // Get the handler
      const handler = getRouteHandler('/schedule', 'post');
