...
describe('Certificate Model', () => {
  ...
  beforeAll(async () => {
    ...
    const defineCertificateModel = (await import('../../../../backend/database/models/Certificate.js')).default;
    const defineBookingModel = (await import('../../../../backend/database/models/Booking.js')).default;
