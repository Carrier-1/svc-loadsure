          ...
          <div class="modal-body" v-if="selectedQuote">
            <div class="quote-details">
              ...
              <div class="detail-row">
                ...
                <span class="value">${{ selectedQuote.premium.toFixed(2) }}</span>
              </div>
              ...
              <div class="detail-row" v-if="selectedQuote.integrationFeeAmount">
                ...
                <span class="value">${{ parseFloat(selectedQuote.integrationFeeAmount).toFixed(2) }}</span>
              </div>
              <div class="detail-row">
                <span class="label">Coverage Amount:</span>
                <span class="value">${{ selectedQuote.coverageAmount.toFixed(2) }}</span>
              </div>
              <div class="detail-row">
                <span class="label">Deductible:</span>
                <span class="value">${{ selectedQuote.deductible.toFixed(2) }}</span>
              </div>
              <div class="detail-row">
      ...
      sortQuotes() {
        ...
        this.filteredQuotes.sort((a, b) => {
          ...
          if (this.sortColumn === 'description') {
            ...
            valueA = parseFloat(a[this.sortColumn]);
            valueB = parseFloat(b[this.sortColumn]);
          } else {
